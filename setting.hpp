...
const std::vector<Setting> setting_options {
 ...
 {"motion-cvmask-beta", "3.0", "Motion CVMask Tau <0.0-255.0>", "Beta parameter for CVMask Algorithm", SETTING_OPTIONAL_CAMERA},
 {"motion-cvmask-threshold", "0.01", "Motion CVMask Threshold <1-255>", "Threshold parameter for CVMask Algorithm", SETTING_OPTIONAL_CAMERA},
